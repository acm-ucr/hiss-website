...
const Title = ({ title }) => {
  return (
    <div className="">
      ...
      <div className="text-white text-right pr-7 pt-3 font-poppins font-bold text-2xl h-16 w-2/5 bg-gradient-to-r from-hiss-blue to-hiss-purple rounded-r-full">
        {title}
      </div>
    </div>
  );
