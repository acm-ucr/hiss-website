...
const Card = ({ text, icon, link }) => {
  return (
    <div className="bg-white flex flex-col items-center pt-4 pb-12 w-28 sm:w-40 md:w-48 rounded-2xl border-1 shadow">
      ...
      <button className="w-3/5 h-10 border-1 border-black hover:border-none hover:text-white hover:bg-hiss-blue rounded-full flex items-center justify-center mt-6">
