...
const Landing = () => {
  return (
    <div className="w-full flex justify-center items-center h-[70vh] relative">
      <div className="flex-row w-auto">
        <div className="h-auto flex sm:flex-row flex-col gap-8 items-center">
          ...
          <div className="px-2 flex w-full justify-center items-start relative">
            <div className="flex flex-col w-3/4 lg:w-auto">
              ...
              <div className="flex flex-col">
                <p className="sm:m-0 mr-24 text-white px-0 py-2.5 font-bold text-center sm:text-3xl sm:h-14 sm:w-4/5 w-80 bg-gradient-to-r from-hiss-blue to-hiss-purple rounded-full items-start relative">
                  at Unversity of California Riverside
                </p>

                <p className="sm:my-1 py-1 h-10 sm:w-6/12 w-full items-start">
