        ...
        <div className="h-auto flex gap-8 ">
          ...
          <div className="px-3 flex w-full justify-center items-start">
            <div className="flex flex-col w-3/4 lg:w-auto">
              ...
              <p className="mt-0 my-0 text-white px-0 py-2.5 font-bold text-center text-3xl h-14 w-[77vh] bg-gradient-to-r from-hiss-blue to-hiss-purple rounded-full">
