...
const Modal = ({ event, setEvent }) => {
  return (
    <div className="font-playfair fixed top-[56%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75vw] md:w-[50vw] bg-hiss-yellow z-10 drop-shadow-lg">
      <div className={`flex justify-between items-center ${event.color}`}>
        ...
        <AiOutlinePlus
          ...
          className="text-hiss-black rotate-45 p-0 hover:scale-110 duration-300 hover:cursor-pointer text-3xl m-3"
        />
      </div>
      <div className="p-3">
